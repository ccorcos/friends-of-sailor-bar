...
- **Legacy Places pages.** The three source records categorized as Places were formatted as separate pages under About Sailor Bar. Pasted Google-search wrappers, generated comments, computed styles, and empty blocks were removed; all visible text, links, captions, and media remain.
...
- **Remaining Partners pages.** All four records were formatted as separate Our Partners pages. Line-break-separated FOLFAN programs and separately wrapped list items became Markdown lists without changing their wording. Source images and credits remain in the page bodies.
