...
| about/grinding-rocks.md | grinding-rocks | 3/3 | /files/Grinding-Rocks-at-Sailor-Bar-300x225.jpg |
| about/heron-rookeries.md | heron-rookeries | 10/10 | — |
| about/flag-pole.md | flag-pole | 5/5 | — |
...
| history/gold-rush-legacy.md | sailor-bar-history | 4/4 | — |
| history/the-ghost-of-sailor-bar.md | the-ghost-of-sailor-bar | 3/3 | /files/Ghost-of-Sailor-Bar.pdf |
...
| partners/american-river-parkway-equestrian-patrol.md | american-river-parkway-equestrian-patrol | 4/4 | /files/American-River-Equestrian-Trail-Patrol.png |
| partners/friends-of-lakes-folsom-and-natoma-folfan.md | friends-of-lakes-folsom-and-natoma-folfan | 10/10 | — |
| partners/project-pick-up-fishing-line.md | project-pick-up-fishing-line | 6/6 | — |
| partners/sacramento-bird-alliance.md | sacramento-bird-alliance | 4/4 | /files/American_River_1_Larry_Hickey.JPG |
...
- **Section names.** The promoted directory labels use the concise titles “Sailor Bar,” “History,” and “Partners.” The complete legacy articles remain unchanged beneath those titles.
...
- **Legacy Places pages.** The three source records categorized as Places were formatted as separate pages under Sailor Bar. Pasted Google-search wrappers, generated comments, computed styles, and empty blocks were removed; all visible text, links, captions, and media remain.
- **Remaining History pages.** Gold Rush Legacy preserves the source’s wording and punctuation exactly, including “planned for gold,” “historically been,” and the two historical-dollar claims. The Ghost of Sailor Bar PDF embed became a plain Markdown link with the same visible label.
- **Remaining Partners pages.** All four records were formatted as separate Partners pages. Line-break-separated FOLFAN programs and separately wrapped list items became Markdown lists without changing their wording. Source images and credits remain in the page bodies.
